...
public class tuuhii_ed_huraalt_add extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tuuhii_ed_huraalt_burtgel);
	...
	public void DBCreate() {
		...
		SQLITEDATABASE
				.execSQL("CREATE TABLE IF NOT EXISTS huraalt(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, malturul VARCHAR, hemjee VARCHAR, count VARCHAR, date VARCHAR);");
	}
	...
	public void SubmitData2SQLiteDB() {
		...
		if (CheckEditTextEmpty == true) {
			...
			SQLiteQuery = "INSERT INTO huraalt(malturul, hemjee, count, date) VALUES('"
					+ malturul
					+ "', '"
					+ hemjee
					+ "', '"
