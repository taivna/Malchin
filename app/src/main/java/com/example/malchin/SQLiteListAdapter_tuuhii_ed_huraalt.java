...
public class SQLiteListAdapter_tuuhii_ed_huraalt extends BaseAdapter {
	...
	public SQLiteListAdapter_tuuhii_ed_huraalt(Context context2, ArrayList<String> id,
	...
	public View getView(int position, View child, ViewGroup parent) {
		...
		if (child == null) {
			...
			child = layoutInflater.inflate(R.layout.listviewdatalayout_tuuhii_ed_huraalt,
					null);
